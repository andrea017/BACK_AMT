...
import com.portfolio.amt.Dto.dtoExperiencia;
import com.portfolio.amt.Entity.Experiencia;
import com.portfolio.amt.Security.Controller.Mensaje;
import com.portfolio.amt.Service.ExperienciaService;
...
public class ExperienciaController {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp) {
        ...
        if (StringUtils.isBlank(dtoexp.getNombreE())) 
            ...
            experiencia.setTareasE(dtoexp.getTareasE());
